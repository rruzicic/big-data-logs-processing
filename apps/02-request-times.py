...
# dfFromTXT.show()
dfDistinct = dfFromTXT.groupBy(window(col('time_local'), '1 hour')).count().show(truncate=False)

# dfDistinct \
#   .write \
#     .mode("overwrite") \
#     .option("driver", "org.postgresql.Driver") \
#     .jdbc("jdbc:postgresql://postgres/postgres", "public.requesttimes", properties={"user": "postgres", "password": "pass"}) \
