...
dfDistinct = dfFromTXT.groupBy('remote_addr').sum('body_bytes_sent')

dfDistinct \
  .write \
    .mode("overwrite") \
    .option("driver", "org.postgresql.Driver") \
    .jdbc("jdbc:postgresql://postgres/postgres", "public.mostdata", properties={"user": "postgres", "password": "pass"}) \
