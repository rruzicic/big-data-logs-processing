...
# dfFromTXT.show()
dfDistinct = dfFromTXT.groupBy('http_user_agent.browser_family').count()

dfDistinct \
  .write \
    .mode("overwrite") \
    .option("driver", "org.postgresql.Driver") \
    .jdbc("jdbc:postgresql://postgres/postgres", "public.commonbrowser", properties={"user": "postgres", "password": "pass"}) \
