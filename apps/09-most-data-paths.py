...
dfDistinct = dfFromTXT.groupBy('request.path').sum('body_bytes_sent')

dfDistinct \
  .write \
    .mode("overwrite") \
    .option("driver", "org.postgresql.Driver") \
    .jdbc("jdbc:postgresql://postgres/postgres", "public.mostdatapath", properties={"user": "postgres", "password": "pass"}) \
